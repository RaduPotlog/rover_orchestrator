...
25 unit tests covering the mission state machine, the policy and the use case, plus the
domain-purity check. All run without a ROS graph, which is the point of the `_core` split.
