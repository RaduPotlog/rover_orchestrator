...
#
# Fails if any file under include/rover_navigation/domain/ or src/domain/ includes a ROS or
...
PKG_DIR="$1"
DOMAIN_DIRS=(
    "${PKG_DIR}/include/rover_navigation/domain"
    "${PKG_DIR}/src/domain"
)
...
ALLOWED_QUOTED_PATTERN='^rover_navigation/domain/([^/]+/)?[^/]+\.hpp$'
